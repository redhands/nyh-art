...
상단 브랜드의 작은 문구는 `hero.title`을 자동으로 따라갑니다.

굵게 표시하고 싶은 부분은 `**텍스트**`처럼 감쌉니다.

```json
"body": "**꿈과 희망**을 기록합니다."
```

여러 줄 문장은 문자열 배열로 적을 수 있습니다. 빈 줄은 `""`로 넣습니다.

```json
"body2": [
  "개인전",
  "2026. 01 초대 개인전 <꿈결조각모음>, 백희아트스페이스",
  "",
  "수상",
  "2024. 05 이수그룹 x 픽스필즈 아트워크 공모전 우승"
]
```
